...
|  符号 |  描述  																	|  例子  						|	
| :---- | :---------------------------------------------------------------------	| :---------------------------	|						
| &     | 如果相对应位都是1，则结果为1，否则为0 									| (3＆1) 得到1，即 0011,0001	|					
| \|    | 如果相对应位都是 0，则结果为 0，否则为 1 									| (4\|1) 得到5，即 0110,0001	|					
| ^     | 如果相对应位值相同，则结果为0，否则为1 									| (3^1) 得到2，即 0011,0001 	|					
| ~     | 取反，即0变成1，1变成0。 													| (~A) 得到-61，即 1100 0011	|				
| <<    | 左移，左操作数按位左移右操作数指定的位数。 								| (8<<2) 得到32，即 0010 0000	|					
| >>    | 右移，左操作数按位右移右操作数指定的位数。 								| (32>>2) 得到8，即 0000 1000 	|			
| >>>   | 右移补零，左操作数的值按右操作数指定的位数右移，移动得到的空位以零填充。 	| (31>>>2) 得到7，即 0001 1111	|	
